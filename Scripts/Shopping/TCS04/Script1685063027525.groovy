...
WebUI.click(findTestObject('Object Repository/Logout/Page_Swag Labs/button_Add to cart'))

WebUI.click(findTestObject('Object Repository/Logout/Page_Swag Labs/button_Add to cart_1'))
